...
exports.McpConnectorNode = void 0;
const mcp_client_pool_1 = require("./mcp-client-pool");
const mcp_app_registry_1 = require("./mcp-app-registry");
exports.McpConnectorNode = {
    description: {
    ...
    async execute() {
        ...
        const preset = (0, mcp_app_registry_1.getMcpAppPreset)(appName);
        ...
        try {
            const pool = mcp_client_pool_1.McpClientPool.getInstance();
