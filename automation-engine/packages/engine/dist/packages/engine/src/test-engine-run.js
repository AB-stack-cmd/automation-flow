...
async function runIntegrationTest() {
    ...
    try {
        ...
        const result1 = await (0, executor_1.executeWorkflow)(workflow.id, "Manual Trigger", {
        ...
        const result2 = await (0, executor_1.executeWorkflow)(workflow.id, "Manual Trigger", {
