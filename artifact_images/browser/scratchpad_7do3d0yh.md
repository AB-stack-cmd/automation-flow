# Verification checklist of Excel AI Automation feature

- [x] Navigate to http://localhost:3000
- [x] Verify 'Excel AI Automation' card is present on landing page
- [x] Click 'Launch Excel AI' button to navigate to `/excel`
- [x] Verify default grid loads with Alice, Bob, Charlie, Diana
- [x] Click the 'Sales Leads' preset button
